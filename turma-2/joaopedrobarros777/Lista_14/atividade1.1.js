...
function listaTodosProdutos() {
  axios.get('http://localhost:3000/produtos')
    .then(respostaDaApi => {
      console.log(respostaDaApi.data)      // let produtoEscolhido = rs.questionInt("Qual produto você quer?")      // listaProduto(produtoEscolhido)
    })
}
...
listaTodosProdutos()
// LISTA 14.1// Ex. 1// Criar todas essas operações para o nosso mercado
...
//criaNovoProduto("x-mignon", 'classico', 150, 1)
//criaNovoProduto("qualquer coisa", 'sei la', 10, 1)
//criaNovoProduto("quaquercoisa2", 'seila2', 20, 1)
